...
import { enrichCompanyData, anonymizeDescription, generateInfographic, analyzeImage } from './actions';
        ...
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-5xl mx-auto">
                <header className="mb-8 flex justify-between items-center">
                    <h1 className="text-3xl font-bold text-gray-900">Brand Presence Test</h1>
